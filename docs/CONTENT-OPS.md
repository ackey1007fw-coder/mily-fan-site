...
- `news.ts` は61件。くまフィルターの「2位を守り抜きたい」Storyは既存b43-02と同一のため追加しない。
  新たに、b44-02（現在1位／102,700pt／31日は1.5倍DAY）、b44-01（公式1.5倍デーの緊急告知）、
  投票方法案内のInstagram Story、b44-04（SHOWROOM 30日連続配信記念日）をNEWSへ追加する。
- HOME Latest / `/news/` と Gallery は、b44-02 / b44-01 / b44-04 について公開MP4 1本・poster 1枚・
  manifest object 1件を共有する。`galleryVideos.ts` は独立動画24本＋Mixch
  outbound player 4本。投票方法案内の動画は自己ホストしない。
...
- 元動画の未確認音声は公開派生から削除する。映像は720×1280を維持する。
  ...
  b44-04は1fps・20フレーム・20.000秒。crop・scale・短縮・テロップ変更・AI加工はしない。
- 同日8/31は `sameDayOrder: 3`（1位）→ `2`（1.5倍デー）→ `1`（投票方法）。
  同日8/30の30日連続配信記念日は unranked で、Mixch最終日のあと。
