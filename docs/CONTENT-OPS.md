...
- ボード2枚は NEWS専用の自己ホストJPEG（b48-01 / b48-02）。
  代表 `media` はあっきーさんボード（トマトの栄養素 / 1人目）。
  やすぴさんボードは `additionalMedia` のみ。Gallery には出さない。
