...
| `supportEvents.ts` | CAMPUS GIRLS 2027 予選A FinalSTAGEのPaton投票期間（2026-08-26 18:00〜2026-09-01 23:59 JST） | Patonイベント詳細・三橋莉子（みりぃ）出場者ページ | 期間中のみホーム最優先CTAとSupport NOWへ表示。終了後、ホームはENTRY 734導線へ戻る |
