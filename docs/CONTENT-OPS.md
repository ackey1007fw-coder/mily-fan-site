...
### 2026-08-30〜31 本人X投稿5件（テキスト／リンク＋朝お礼写真）
...
- 8/30 05:48のPaton順位
  ...
  8/31の1位カードと混ぜない。
- 8/31 07:34のお礼投稿
  `https://x.com/Mily_chan36/status/2094192106105659650` はNEWS＋Galleryで
  b44-01本人写真を共有する。CTAは確認済みSHOWROOMルーム（`t=` なし）。
  LIVE STREAMのみ。`sameDayOrder: 3` で8/31の先頭。X画像CDNは参照しない。
  視聴者の表示名・順位バーの個人名は本文・altに書かない。
- `/stories/`、events、streamSchedule、profile、highlights、
