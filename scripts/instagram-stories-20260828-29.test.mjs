...
describe("2026-08-28〜29 Instagram Story動画 — Latest / NEWS", () => {
  it("adds two separately dated Story records in confirmed editorial order", () => {
    ...
    assert.equal(ordered[3]?.id, "2026-08-31-morning-stream-thanks");
    assert.equal(ordered[4]?.id, "2026-08-31-paton-15x-day");
    assert.equal(ordered[5]?.id, "2026-08-31-showroom-wake-me");
    assert.equal(ordered[6]?.id, "2026-08-30-consecutive-stream-30");
    assert.equal(ordered[7]?.id, "2026-08-30-campus-girls-hold-second-story");
    assert.equal(ordered[8]?.id, "2026-08-30-morning-showroom-0600");
    assert.equal(ordered[9]?.id, "2026-08-30-mixch-final-day");
    assert.equal(ordered[10]?.id, "2026-08-30-showroom-30-day-story");
    assert.equal(ordered[11]?.id, "2026-08-30-paton-rank-3");
    assert.equal(ordered[12]?.id, "2026-08-29-paton-vote-day-5-story");
    assert.equal(ordered[13]?.id, "2026-08-29-showroom-live-third-round");
    assert.equal(ordered[14]?.id, "2026-08-29-showroom-radio-1440");
    assert.equal(ordered[15], paton);
    assert.equal(ordered[16]?.id, "2026-08-28-stream-thanks");
    assert.equal(ordered[17], night);
    assert.equal(ordered[18]?.id, "2026-08-28-paton-vote-day-3");
  ...
  it("surfaces the new records and canonical videos on their explicit Activities", () => {
    ...
    assert.equal(campusNews[3]?.id, "2026-08-31-paton-15x-day");
    assert.equal(campusNews[4]?.id, "2026-08-30-campus-girls-hold-second-story");
    assert.equal(campusNews[5]?.id, "2026-08-30-mixch-final-day");
    assert.equal(campusNews[6]?.id, "2026-08-30-paton-rank-3");
    assert.equal(campusNews[7]?.id, "2026-08-29-paton-vote-day-5-story");
