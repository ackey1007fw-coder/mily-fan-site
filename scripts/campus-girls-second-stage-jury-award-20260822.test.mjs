...
describe("2026-08-22 CAMPUS GIRLS 2nd STAGE milestone", () => {
  ...
  it("keeps the campus milestone on 8/22 after same-day Fan Room updates", () => {
    ...
    const aug22 = sortNewsByDateDesc(news.filter((entry) => entry.id !== "2026-08-27-mixch-expressive").filter((entry) => entry.id !== "2026-08-27-x-followers-100").filter((entry) => entry.id !== "2026-08-27-seaside-circle-movie-theme-story").filter((entry) => entry.id !== "2026-08-27-miss-circle-showroom-story"))
