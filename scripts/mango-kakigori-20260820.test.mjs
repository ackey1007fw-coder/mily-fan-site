...
describe("2026-08-20 mango kakigori Instagram post — NEWS", () => {
  it("adds one source-backed Latest item without a duplicate url", () => {
    ...
    assert.equal(ordered[2].id, "2026-08-25-mixch-confidence-message");
    assert.equal(ordered[3].id, "2026-08-25-motivation");
    assert.equal(ordered[4].id, "2026-08-24-seasidecircle-yes-tokyo");
    assert.equal(ordered[5].id, "2026-08-24-campus-girls-final-stage-guide");
    assert.equal(ordered[6].id, "2026-08-24-makeup-stream");
    assert.equal(ordered[7].id, "2026-08-24-night-thanks-morning-stream");
    assert.equal(ordered[8].id, "2026-08-23-dragon-cloud");
    assert.equal(ordered[9].id, "2026-08-23-seaside-circle-musical-special");
    assert.equal(ordered[10].id, "2026-08-23-morning-showroom-fanroom");
    assert.equal(ordered[11].id, "2026-08-23-early-showroom-fanroom");
    assert.equal(ordered[12].id, "2026-08-23-earthquake-showroom-fanroom");
    assert.equal(ordered[13].id, "2026-08-22-night-showroom-thanks");
    assert.equal(ordered[14].id, "2026-08-22-night-showroom-fanroom");
    assert.equal(ordered[15].id, "2026-08-22-evening-showroom-fanroom");
    assert.equal(ordered[16].id, "2026-08-22-campus-girls-second-stage-jury-award");
    assert.equal(ordered[17].id, "2026-08-21-tiktok-radio-misscircle");
    assert.equal(ordered[18].id, "2026-08-21-after-afternoon-ganda");
    assert.equal(ordered[19].id, "2026-08-21-afternoon-showroom-fanroom");
    assert.equal(ordered[20].id, "2026-08-21-event-story-next-slot");
    assert.equal(ordered[21].id, "2026-08-21-morning-ohayo-story");
    assert.equal(ordered[22].id, "2026-08-21-morning-showroom-runway");
    assert.equal(ordered[23].id, NEWS_ID);
  });
