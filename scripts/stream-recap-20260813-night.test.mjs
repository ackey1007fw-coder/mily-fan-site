...
describe("2026-08-13 night caption-audit recap", () => {
  ...
  it("keeps only facts confirmed by the saved caption audit", () => {
    ...
    assert.match(recap.nextNote, /11時30分/);
    assert.match(recap.nextNote, /歌/);
  });
  ...
  it("keeps timestamps ordered and unpublished stills neutral", () => {
    ...
    assert.match(recap.transcriptionNote, /1,683行/);
