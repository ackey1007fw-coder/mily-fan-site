...
describe("2026-08-30 Mixch final-day NEWS", () => {
  ...
  it("leads Latest ahead of the 8/29 SHOWROOM posts", () => {
    ...
    assert.equal(ordered[10]?.id, NEWS_ID);
  ...
  it("appears on CAMPUS GIRLS and is derived into the Portal Feed without a local image", () => {
    ...
    assert.equal(selected[0]?.id, "2026-08-31-paton-vote-voice-story");
    assert.equal(selected[1]?.id, "2026-08-31-paton-first-place-story");
    assert.equal(selected[2]?.id, "2026-08-31-paton-15x-day-story");
    assert.equal(selected[3]?.id, "2026-08-31-paton-vote-how-to-story");
    assert.equal(selected[4]?.id, "2026-08-31-paton-15x-day");
    assert.equal(selected[5]?.id, "2026-08-30-campus-girls-hold-second-story");
    assert.equal(selected[6]?.id, NEWS_ID);
    assert.equal(selected[7]?.id, "2026-08-30-paton-rank-3");
    assert.equal(selected[8]?.id, "2026-08-29-paton-vote-day-5-story");
    assert.ok(feedItem);
