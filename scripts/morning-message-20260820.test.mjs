...
describe("2026-08-20 morning X post — stays Latest-only", () => {
  ...
  it("stays above the 8/20 morning Story without deleting it", () => {
    ...
    assert.equal(ordered[5], "2026-08-23-seaside-circle-musical-special");
    ...
    assert.equal(ordered[10], "2026-08-22-night-showroom-fanroom");
    assert.equal(ordered[11], "2026-08-22-evening-showroom-fanroom");
    assert.equal(ordered[12], "2026-08-22-campus-girls-second-stage-jury-award");
    assert.equal(ordered[13], "2026-08-21-tiktok-radio-misscircle");
    assert.equal(ordered[14], "2026-08-21-after-afternoon-ganda");
    assert.equal(ordered[15], "2026-08-21-afternoon-showroom-fanroom");
    assert.equal(ordered[16], "2026-08-21-event-story-next-slot");
    assert.equal(ordered[17], "2026-08-21-morning-ohayo-story");
    assert.equal(ordered[18], "2026-08-21-morning-showroom-runway");
    assert.equal(ordered[19], "2026-08-20-mango-kakigori");
    assert.equal(ordered[20], NEWS_ID);
    assert.equal(ordered[21], "2026-08-20-morning-story");
