...
describe("2026-08-26 CAMPUS GIRLS Paton vote", () => {
  ...
  it("schedules a render refresh at both voting boundaries", () => {
    ...
    const thirdRoundVoteStartDay = Date.parse("2026-09-03T00:00:00+09:00");
    ...
    assert.equal(
      nextSupportEventBoundary(contestEnd),
      Date.parse("2026-09-20T12:00:00+09:00") + 1,
    );
    assert.equal(
      nextSupportEventBoundary(Date.parse("2026-09-20T12:00:00+09:00") + 1),
      null,
    );
  });
