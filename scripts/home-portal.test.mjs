...
describe("home portal information architecture", () => {
  ...
  it("limits home Latest / STORY / Gallery and leaves archive routes as the full lists", () => {
    ...
    assert.ok(sortNewsByDateDesc(news.filter((entry) => entry.id !== "2026-08-27-seaside-circle-movie-theme-story").filter((entry) => entry.id !== "2026-08-27-miss-circle-showroom-story")).length > HOME_NEWS_LIMIT);
