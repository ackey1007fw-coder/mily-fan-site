...
export const streamRecap20260918Day: StreamRecap = {
  ...
  transcriptionNote: buildTranscriptionNote({
    ...
    stills: "静止画は掲載していません。",
    extra: "録画開始記録13:39:52、修復済み記録の実測8108.622秒から表示を13:39頃・約135分に丸めています。保存録画範囲全体を68チャンク・282区間の自動文字起こしで確認しました。後発の短い重複録画との連結はしていません。配信全編の完全収録は保証しません。タイムスタンプは録画先頭からの目安です。独立した歌唱として曲名を確定できた場面はなく、夜の歌唱予告と区別しています。",
  }),
};
