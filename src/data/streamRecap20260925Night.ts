...
export const streamRecap20260925Night: StreamRecap = {
  ...
  summary: "紫のリボンの帽子をかぶって、四次審査までの過ごし方をみんなと相談。配信の魅力を尋ね、届いた応援の言葉に涙と感謝を見せた後は、スイーツや次の配信の話で笑顔のおしゃべりが続きました。",
  image: stills[3],
  gallery: stills,
  galleryZip: {
  ...
  highlights: [
    ...
    },
    {
      timestamp: "1:25:22",
      title: "誕生日をもう一度お祝い",
      body: "終盤には誕生日を迎えた人へ歌でお祝い。何度でも祝っていいと笑い、みんなにも誕生日を教えてねと呼びかけました。",
    },
    {
      timestamp: "1:27:33",
      title: "どんな自分も見守ってね",
      body: "弱いところも見せた夜を振り返り、これからもいろいろな姿の自分を応援してもらえたらうれしいと伝えて締めくくりました。",
    },
  ],
  goals: [],
  ranking: [],
  timeline: [
    ...
    { timestamp: "1:11:22", label: "アバターにびっくり" },
    { timestamp: "1:16:32", label: "最後のあいさつの合図を相談" },
    { timestamp: "1:25:22", label: "誕生日を歌でお祝い" },
    { timestamp: "1:27:33", label: "いろいろな姿を応援してほしいと感謝" },
    { timestamp: "1:28:10", label: "翌朝5:30の配信を案内" },
  ],
  nextNote: "配信終盤に、翌朝は5:30から配信すると案内していました。配信時点の案内であり、現在の予定ではありません。",
  sourceLabel: "2026年9月25日 SHOWROOM夜配信（保存録画・自動文字起こし確認）",
  verifiedAt: "2026-09-26",
  transcriptionNote: buildTranscriptionNote({
    material: AUTO_TRANSCRIPT_MATERIAL_NOTE,
    stills: "静止画は同じ録画の実フレーム10枚を掲載しています。",
    extra: "録画開始記録21:31:54、メディア実測5410.862秒。録画全体を46分割して自動文字起こしした1,927区間を確認し、主要な場面と実フレームを照合しました。全編手動聴取・逐語校正ではありません。時刻は録画先頭からの目安です。",
  }),
};
