...
export const streamRecap20260917Yoru: StreamRecap = {
  ...
  highlights: [
    ...
    { timestamp: "0:10:29", title: "自分を卑下しないで", body: "応援のやり取りでは、自分を卑下しないでと声をかけ、相手の存在を「素敵」と表現しました。" },
    { timestamp: "0:16:58", title: "まかないはフルコース", body: "お肉にスープ、キムチ、サラダもそろう、まかないの話へ。フルコースのような食事だと紹介し、お腹いっぱい食べられる充実ぶりを話しました。" },
    { timestamp: "0:20:47", title: "お化け屋敷は苦手", body: "お化け屋敷の話題では、絶対に行きたくないと即答。自分の悲鳴に周りも驚くと話し、行くなら出口まで一緒にいてほしいと返しました。" },
    { timestamp: "0:29:49", title: "今夜はラジオ形式", body: "今夜はラジオ配信なのかという問いに、今日はラジオ形式でおしゃべりしていると説明。声だけの配信でもコメントに応じながら会話を続けました。" },
    { timestamp: "0:32:03", title: "ラジオで話す経験", body: "ラジオパーソナリティをしていることに触れ、ラジオで長く話す経験の成果が配信にも出ているかもしれないと話しました。" },
