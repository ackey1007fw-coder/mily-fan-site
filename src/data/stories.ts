  ...
  sections: [
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: "2026年8月23日 10:00〜13:00、FM湘南マジックウェイブの「湘南シーサイドサークル」は「真夏のミュージカル特集」をお届けしました。パーソナリティは師匠とMily（みりぃ）、ディレクターはかず坊。前半約2時間のスペシャルゲストは、歌手でミュージカル俳優の清水美依紗さんでした。",
          sourceIds: [
            "broadcast-transcript-2026-08-23",
            "program-instagram-story-2026-08-23",
          ],
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          text: "みりぃは、大学3年生として人生の岐路に立つ中で、今の自分に刺さる話をたくさん聞けたと振り返りました。",
          sourceIds: ["broadcast-transcript-2026-08-23"],
        },
      ],
    },
