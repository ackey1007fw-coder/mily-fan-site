...
export const streamRecap20260912Yoru: StreamRecap = {
  ...
  transcriptionNote: buildTranscriptionNote({
    ...
    extra: "確認用音声約2時間13分の自動文字起こしを全文照合しました。複数録画の重複を照合した統合記録の先頭からの目安です。全編手動聴取と録画の完全性の検証は未実施です。21:59はSHOWROOM審査の締切で、配信終了時刻ではありません。歌唱動画は利用条件確認のため掲載を保留しています。録画全体を概観し、第三者やコメント欄が写らない実フレーム10枚を選定し、オーナーの掲載承認を確認しています。",
  }),
};
