...
export const streamRecap20260905Night: StreamRecap = {
  ...
  "highlights": [
    ...
    },
    {
      "timestamp": "0:06:15",
      "title": "みんなで少しずつ、目標へ",
      "body": "WEB投票と100キラでの応援を呼びかけ、アバター制作権の獲得も目標として紹介。一人にたくさんお願いするのではなく、ルームのみんなで力を合わせて上を目指したいと話していました。"
    },
    {
      "timestamp": "0:14:50",
      "title": "篠笛を手に、おしゃべり",
  ...
  "goals": [
    ...
    },
    {
      "item": "100キラ",
      "target": "みんなで少しずつ",
      "statusThen": "応援したいと思ってもらえるよう頑張りたい"
    },
    {
      "item": "アバター制作権",
      "target": "獲得を目指す",
