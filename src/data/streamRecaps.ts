...
const gachiMorningStills: StreamRecapImage[] = [
  {
    ...
    alt: "三次初日の朝配信で、ベージュのトップスのみりぃがピースをして大きく笑っている。画面左上にSHOWROOMの文字",
  ...
  },
  {
    ...
    width: GACHI_STILL_W,
    height: GACHI_STILL_H,
    alt: "三次初日の朝配信で、ピースをしながら話しているみりぃ",
    caption: "ピースしながら話す",
    downloadName: "みりぃ_三次初日朝_03_ピース話し.jpg",
  },
  {
...
export const streamRecap20260903: StreamRecap = {
  ...
  timeline: [
    ...
    { timestamp: "0:12:00", label: "ピースと笑顔" },
