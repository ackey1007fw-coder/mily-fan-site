...
export const news: NewsItem[] = [
  {
    ...
    body: "8月20日から26日まで挑戦した、Rakuten GirlsAward 2026 A/Wのランウェイ出演をかけたSHOWROOMイベントが終了。みりぃは6位でフィニッシュしました。終了後のXでは「皆さんのおかげでとーーーっても楽しかった」と感謝を伝え、挑戦する怖さを越えて一歩踏み出せたこと、みんなに出逢い応援してもらえたことを「幸せじゃっ」と振り返っています。最後まで一緒に走った皆さんへ、これからもよろしくお願いしますという言葉も届けました。",
