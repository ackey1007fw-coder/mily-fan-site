          ...
          <ul className="mt-3 space-y-3">
            {recap.highlights.map((highlight) => (
              ...
              >
                ...
                {highlight.relatedLinks ? <div className="mt-2 flex flex-wrap gap-x-5 gap-y-1">{highlight.relatedLinks.map((link) => <ExternalLink key={link.url} href={link.url} className="inline-flex min-h-11 items-center text-sm font-semibold text-sage-deep underline underline-offset-4">{link.label} ↗</ExternalLink>)}</div> : null}
